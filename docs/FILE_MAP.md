...
Поддерживаемые файлы проекта. Временные данные, секреты, зависимости и результаты сборки исключены из Git. Назначение файлов также находится в README каждой папки.
